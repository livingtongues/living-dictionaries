...
export const mock_analytics: LogAnalytics = {
  ...
  locales: {
    sessions_with_browser_locale: 1180,
    sessions_with_ui_locale: 1102,
    browser: [
      { locale: 'en', visitors: 512, sessions: 731, supported: true },
      { locale: 'es', visitors: 214, sessions: 289, supported: true },
      { locale: 'pt', visitors: 88, sessions: 120, supported: true },
      { locale: 'pl', visitors: 64, sessions: 71, supported: false },
      { locale: 'fil', visitors: 41, sessions: 55, supported: false },
      { locale: 'fr', visitors: 39, sessions: 44, supported: true },
      { locale: 'th', visitors: 22, sessions: 25, supported: false },
      { locale: 'zh-TW', visitors: 14, sessions: 18, supported: true },
    ],
    in_use: [
      { locale: 'en', visitors: 803, sessions: 962, supported: true },
      { locale: 'es', visitors: 141, sessions: 197, supported: true },
      { locale: 'fr', visitors: 21, sessions: 24, supported: true },
      { locale: 'zh-TW', visitors: 9, sessions: 12, supported: true },
    ],
    mismatch: [
      { locale: 'es', visitors: 73 },
      { locale: 'pt', visitors: 52 },
      { locale: 'fr', visitors: 18 },
    ],
    mismatch_visitors: 143,
  },
  missing_i18n_keys: {
    total: 875,
    distinct_keys: 237,
