...
export const seeded_user_email_1 = 'jacob@livingtongues.org'
export const seeded_user_password_1 = 'password1'
const seeded_user_email_2 = 'diego@livingtongues.org'

export const users = [
  {
    id: seeded_user_id_1,
    email: seeded_user_email_1,
    password: seeded_user_password_1,
