...
export const POST: RequestHandler = async (event) => {
  ...
  if (target_user) {
    ...
    log_server_event({ level: 'info', message: 'dictionary_role_granted', user_id: auth.user_id, context: { dictionary_id: dict_id, target_user_id: target_user.id, role } })
  ...
  log_server_event({ level: 'info', message: 'dictionary_invite_created', user_id: auth.user_id, context: { dictionary_id: dict_id, role } })
