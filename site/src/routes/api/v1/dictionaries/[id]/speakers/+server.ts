...
export const POST: RequestHandler = async (event) => {
  ...
  log_server_event({ level: 'info', message: 'v1_speaker_created', user_id: access.user_id, context: { dictionary_id: dictionary.id, speaker_id: result.speaker.id, via: access.via } })
