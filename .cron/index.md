...
|---|---|---|---|---|
| `living-dictionaries/log-review` | `.cron/log-review.md` (repo, `runs_on: mustang`) | `every: 0 21 * * *` (daily 21:00) | `.claude/commands/log-and-fix.md` end-to-end | `.cron/log-reviews/YYYY-MM-DD.md` + chat summary |
