...
type Entry_Fields = 'lexeme' | `localOrthography${Number_Suffix}` | 'phonetic' | 'dialects' | 'tags' | 'ID' | 'notes' | 'linguisticHistory' | 'source' | 'morphology' | 'interlinearization' | 'scientificName'
