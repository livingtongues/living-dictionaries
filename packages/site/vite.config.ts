...
export default defineConfig({
  ...
  optimizeDeps: {
    include: [ // if the dependency is large with many internal modules or is CommonJS then include it
      ...
      // 'firebase/functions', 'firebase/firestore', 'firebase/app', 'firebase/firestore/lite', 'firebase/auth', 'firebase/performance',
      // 'instantsearch.js/es/widgets/index.js', 'instantsearch.js/es/connectors', 'algoliasearch', 'instantsearch.js',
    ],
