...
<div class="max-w-screen-md mx-auto p-3">
  <div class="tw-prose max-w-none">
    <h2 class="uppercase">{$t('terms.agreement_to_terms', { default: 'Agreement to Terms' })}</h2>
    <div style="direction: ltr">
      ...
      <p>
        ...
        and personal use only. Except as expressly provided in these Terms of Use, no part of the
        Site and no Content or Marks may be copied, reproduced, aggregated, republished, uploaded,
      ...
      <p>
        Notwithstanding the foregoing, in the event any endangered language community requests that
        any Content or any portion thereof on the Site pertaining to their community be removed for
        any reason, including any claim of infringement, any and all licenses granted you with
        respect to such Content shall immediately terminate, you shall cease any use thereof and
        remove such Content or portion thereof from all your devices and such Content shall no
        longer be subject to the license granted herein.
      </p>
      ...
      <ol>
        ...
        <li>
          You have the written or recorded (audio or video) consent, release, and/or permission of
          ...
          of your Contributions in any manner contemplated by the Site and these Terms of Use; it
          being understood and agreed that all Contributions shall at all times remain subject to
          Licensor’s policy on intellectual property rights and the rights retained by the
          respective endangered language communities and will be promptly removed from our Site at
          the request of any such endangered language community.
        </li>
      ...
      <p>
        We do not assert any ownership over your Contributions. You retain all rights and retain
        full ownership of all of your Contributions and any intellectual property rights or other
        proprietary rights associated with your Contributions. We are not liable for any statements
        or representations in your Contributions provided by you in any area on the Site. You are
        solely responsible for your Contributions to the Site and you expressly agree to exonerate
        us from any and all responsibility and to refrain from any legal action against us regarding
        your Contributions.
      </p>
      <p>
      ...
      <p>
        ...
        mobile application license contained in these Terms of Use. You shall not: (1) decompile,
        reverse engineer, disassemble, attempt to derive the source code of, or decrypt the
        application; (2) make any modification, adaptation, improvement, enhancement, translation,
        or derivative work from the application; (3) violate any applicable laws, rules, or
        regulations in connection with your access or use of the application; (4) remove, alter, or
        obscure any proprietary notice (including any notice of copyright or trademark) posted by us
        or the licensors of the application; (5) use the application for any revenue generating
        endeavor, commercial enterprise, or other purpose for which it is not designed or intended;
        (6) make the application available over a network or other environment permitting access or
        use by multiple devices or users at the same time; (7) use the application for creating a
        product, service, or software that is, directly or indirectly, competitive with or in any
        way a substitute for the application; (8) use the application to send automated queries to
      ...
      <p>
        ...
        transferred to and processed in the United States. Further, we do not knowingly accept,
        ...
        knowledge that anyone under the age of 13 has provided personal information to us without
      ...
      <p>
        ...
        following information: (1) A physical or electronic signature of a person authorized to act
        on behalf of the owner of an exclusive right that is allegedly infringed; (2) identification
        of the copyrighted work claimed to have been infringed, or, if multiple copyrighted works on
        the Site are covered by the Notification, a representative list of such works on the Site;
        ...
        contacted; (5) a statement that the complaining party has a good faith belief that use of
      ...
      <p>
        ...
        Notification must include substantially the following: (1) identification of the material
        that has been removed or disabled and the location at which the material appeared before it
        ...
        States, for any judicial district in which we are located; (3) a statement that you will
        accept service of process from the party that filed the Notification or the party's agent;
        (4) your name, address, and telephone number; (5) a statement under penalty of perjury that
        you have a good faith belief that the material in question was removed or disabled as a
        result of a mistake or misidentification of the material to be removed or disabled; and (6)
      ...
      <p>
        ...
        the laws of the State of Delaware applicable to agreements made and to be entirely performed
        within the State of Delaware , without regard to its conflict of law principles.
      </p>
      ...
      <p>
        ...
        where appropriate, limited by the AAA Consumer Rules. If such costs are determined to by the
        arbitrator to be excessive, we will pay all arbitration fees and expenses. The arbitration
        ...
        unless requested by either Party. The arbitrator must follow applicable law, and any award
        may be challenged if the arbitrator fails to do so. Except where otherwise required by the
        applicable AAA rules or applicable law, the arbitration will take place in United States
        County, Delaware. Except as otherwise provided herein, the Parties may litigate in court to
      ...
      <p>
        ...
        commenced or prosecuted in the state and federal courts located in Kent County County,
        Delaware, and the Parties hereby consent to, and waive all defenses of lack of personal
      ...
      <p>
        ...
        ANY CAUSE OF ACTION ARISING OR $500.00 USD . CERTAIN STATE LAWS DO NOT ALLOW LIMITATIONS ON
      ...
      <p class="font-semibold">
        Living Tongues Institute for Endangered Languages<br />
        4676 Commercial St SE, # 454<br />
        Salem , OR 97302<br />
        United States<br />
        Phone: 5032693962<br />
...
<SeoMetaTags
  title={$t('dictionary.terms_of_use', { default: 'Terms of Use' })}
  description={$t('', { default: 'Terms of Use for the Living Dictionaries platform. This page includes information about the terms, intellectual property rights, user representations, prohibited activities, user-generated contributions, and more.' })}
