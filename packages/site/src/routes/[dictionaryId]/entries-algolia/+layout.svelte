    ...
    <div class="relative pb-3 flex-grow">
      <div
        ...
        <div
          ...
          <a
            href={`/${$page.params.dictionaryId}/entries-algolia/list`}
          ...
          <a
            href={`/${$page.params.dictionaryId}/entries-algolia/table`}
          ...
          <div class="hidden md:block w-1" />
          <a
            href={`/${$page.params.dictionaryId}/entries-algolia/gallery`}
          ...
          {#if $dictionary.printAccess || $can_edit}
            <a
              href={`/${$page.params.dictionaryId}/entries-algolia/print`}
