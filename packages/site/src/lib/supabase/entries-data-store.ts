...
export function create_entries_data_store({
  ...
  const connected_entries_data = derived([entries, senses, audios, speakers, audio_speakers, tags, entry_tags, dialects, entry_dialects, photos, sense_photos, videos, sense_videos, sentences, senses_in_sentences,
  ], ([$entries, $senses, $audios, $speakers, $audio_speakers, $tags, $entry_tags, $dialects, $entry_dialects, $photos, $sense_photos, $videos, $sense_videos, $sentences, $senses_in_sentences,
  ]) => {
    if (log) console.info({ entries: $entries.length, senses: $senses.length, audio: $audios.length, speakers: $speakers.length, audio_speakers: $audio_speakers.length, tags: $tags.length, entry_tags: $entry_tags.length, dialects: $dialects.length, entry_dialects: $entry_dialects.length, photos: $photos.length, sense_photos: $sense_photos.length, videos: $videos.length, sense_videos: $sense_videos.length, sentences: $sentences.length, senses_in_sentences: $senses_in_sentences.length })
  ...
  const loading = derived([
    ...
    return $entries_loading || $senses_loading || $audios_loading || $speakers_loading
      ...
      || $sense_videos_loading || $sentences_loading || $senses_in_sentences_loading
  }, true)
  ...
  const store_error = derived([
    ...
    return $entries_error || $senses_error || $audios_error || $speakers_error
      ...
      || $sense_videos_error || $sentences_error || $senses_in_sentences_error
  }, null)
