...
export function order_glosses({
  ...
  const sorted_gloss_languages = order_entry_and_dictionary_gloss_languages(
    glosses,
    dictionary_gloss_languages
  );
...
export function order_entry_and_dictionary_gloss_languages(
  ...
  const combined_glossing_languages = [
    ...dictionary_gloss_languages,
    ...Object.keys(glosses || {}),
  ];
...
export function get_first_sorted_gloss_safely({
  glosses,
  dictionary_gloss_languages,
  $t,
  label = false,
  ...
  return order_glosses({ glosses, dictionary_gloss_languages, $t, label })[0]
    ? order_glosses({ glosses, dictionary_gloss_languages, $t, label })[0]
    : '';
}
