...
export interface IDictionary extends IFirestoreMetaData {
  ...
  alternateOrthographies?: string[]; // Alternate Orthography titles (first item corresponds to entry.lo1, then entry.lo2, entry.lo3) - used to be called Local Orthography but that is a misnomer it's turning out
