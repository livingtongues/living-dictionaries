...
type AllTranslations = Record<string, TranslationsForLanguage>

type TranslationsForLanguage = Record<string, Record<string, string>>
...
export const getSectionTranslationsFromSpreadsheet = (rows: Record<string | 'key', string>[], options: { section: 'gl' | 'ps' | 'psAbbrev' | 'sd' }) => {
  ...
  languages.forEach((lang) => {
    const translationsForSection: Record<string, string> = {}
