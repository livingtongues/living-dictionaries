CREATE TABLE senses (
  ...
  created_by text NOT NULL, -- TODO: go through existing senses and connect to user_id, then change to uuid and add REFERENCES auth.users (id)
  updated_at timestamp with time zone DEFAULT now() NOT NULL,
  updated_by text NOT NULL, -- TODO: go through existing senses and connect to user_id, then change to uuid and add REFERENCES auth.users (id)
...
CREATE TABLE entry_updates (
  ...
  dictionary_id text NOT NULL, -- TODO: add REFERENCES dictionaries (id) once Firestore data migrated
  entry_id text NOT NULL, -- TODO: add REFERENCES entries (id) once Firestore data migrated
